...
// возвращает множество, состоящее из элементов массива a размера size78.
...
// возвращает истина если множество subSet
// является подмножеством set,
...
// возвращает объединение множеств set1 и set280.
...
// возвращает дополнение до универсума множества set82
unordered_array_set unordered_array_set_complement(unordered_array_set set,
                                                   unordered_array_set universumSet);

// возвращает симметрическую разность множеств set1 и set283
